...
```{r setup-tibble}
usernames <- c("wilsonamy", "Ruairidh", "username 2", "username 3", "username 4") #Extend if necessary
nums <- c(18, 17, NA, NA, NA) #Extend if necessary
colours <- c("powderblue", "gray17", "colour 2", "colour 3", "colour 4") #Extend if necessary
