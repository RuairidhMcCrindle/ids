...
```{r setup-tibble}
usernames <- c("wilsonamy", "Ruairidh", "shiliuborui", "username 3", "username 4") #Extend if necessary
nums <- c(18, 17, 16, NA, NA) #Extend if necessary
colours <- c("powderblue", "gray17", "slateblue4", "colour 3", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Reading", "jogging", "Hobby 3", "Hobby 4") #Extend if necessary
...
### Exercise 18
We now work on visualising our data. Hello
